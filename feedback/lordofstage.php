  ...
  <form class="form-horizontal" role="form" action="success.php" method="post">
      ...
      <div class="tab-content">
        <div id="home" class="tab-pane fade in active">
          <h3>How was the format of event ?</h3>
          <div class="form-group">
            <label class="control-label col-sm-2" for="question1"></label>
              <div class="radio">
                <label><input type="radio" name="question1_op" value="4">Excellent</label>
              </div>
              <div class="radio">
                <label><input type="radio" name="question1_op" value="3">Very good</label>
              </div>
              <div class="radio">
                <label><input type="radio" name="question1_op" value="2">Average</label>
              </div>
              <div class="radio">
        ...
        <div id="menu1" class="tab-pane fade">
          <h3>Were the topics of extempore interesting?.</h3>
          <div class="form-group">
            ...
            <div class="radio">
              ...
              <div class="radio">
                <label><input type="radio" name="question2_op" value="3">Very good</label>
              </div>
              <div class="radio">
        ...
        <div id="menu2" class="tab-pane fade">
          <h3>How was your debate experience ?</h3>
          <div class="form-group">
            <label class="control-label col-sm-2" for="question3"></label>
              <div class="radio">
                <label><input type="radio" name="question3_op" value="4">Excellent</label>
              </div>
              <div class="radio">
                <label><input type="radio" name="question3_op" value="3">Very good</label>
              </div>
              <div class="radio">
                <label><input type="radio" name="question3_op" value="2">Average</label>
              </div>
              <div class="radio">
                <label><input type="radio" name="question3_op" value="1">Poor</label>
              </div>
          </div>
        </div>
        <div id="menu3" class="tab-pane fade">
          <h3>I gained usable skills and will be able to apply them to my academic or social  life.</h3>
          <div class="form-group">
        ...
        <div id="menu4" class="tab-pane fade">
          <h3>What could have been done to improve the Lord Of Stage?</h3>
          <div class="form-group">
        ...
        <div id="menu5" class="tab-pane fade">
          ...
          <div class="form-group">
              <input type="hidden" class="form-control"  id="workshop" name="workshop" value="5" required></input>
          </div>
        </div>
      </div>
      <div class="form-group">        
