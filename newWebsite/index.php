...
<body id="myCarousel" data-spy="scroll" data-target=".navbar" data-offset="60">
      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#myCarousel">POLARIS2K16</a>
          </div>
     ...
     <!-- Start Corosal-->
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="item">
            <img src="img/bg1.jpg" alt="Los Angeles">
            <div class="carousel-caption">
              <h3></h3>
              <p></p>
            </div> 
    ...
    position mat change karana  -->  
      ...
      <div id="slide-3" class="container-fluid text-center bg-grey">
              ...
              <div class="row text-center slideanim">
                ...
                <div class="col-sm-2">
                  <div class="thumbnail wow rotateInLeft animated" data-wow-delay="0.13s">
                    ...
                    <button class="btn btn-lg" data-toggle="modal" data-target="#codeRelayModal">More</button>
                  </div>
                </div>
                ...
                <div class="col-sm-2">
                  <div class="thumbnail wow zoomInUp animated" data-wow-delay="0.8s">
                    ...
                    <p class="ar flipInY"><strong>Crack Jack</strong></p>
                        <button class="btn btn-lg" data-toggle="modal" data-target="#crackJackModal">More</button>
                  </div>
                </div>
                ...
                <div class="col-sm-2">
                  <div class="thumbnail wow rotateInRight animated" data-wow-delay="0.13s">
                    ...
                    <button class="btn btn-lg" data-toggle="modal" data-target="#hotHeadsModal">More</button>
                  </div>
                </div>
                <div class="col-sm-2">
                </div>
              ...
              <div class="row text-center slideanim">
                ...
                <div class="col-sm-2">
                  <div class="thumbnail ar wow zoomInLeft animated" data-wow-delay="0.13s">
                    ...
                    <button class="btn btn-lg" data-toggle="modal" data-target="#lordOfStageModal">More</button>
                  </div>
                </div>
                <div class="col-sm-2">
                </div>
                <div class="col-sm-2">
                  <div class="thumbnail ar wow zoomInRight animated" data-wow-delay="0.13s">
                    ...
                    <p class="ar flipInX"><strong>Projet</strong></p>
                        <button class="btn btn-lg" data-toggle="modal" data-target="#projetModal">More</button>
                  </div>
                </div>
                <div class="col-sm-2">
                </div>
            ...
            <!-- Modal for CodeRelay  -->
            <div class="modal fade" id="codeRelayModal" role="dialog">
            ...
            <!-- Modal for CrackJack  -->
            <div class="modal fade" id="crackJackModal" role="dialog">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        <!-- Modal for Lord Of Stage  -->
            <div class="modal fade" id="lordOfStageModal" role="dialog">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                  ...
                  <div class="modal-body">
                    ...
                    <p>
                      ...
                      to raise the literary profile of a student .Students would be given exposure under pressurised 

                      circumstances and they would be asked to perform their best on stage .This event not only helps 
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        <!-- Modal for Projet  -->
            <div class="modal fade" id="projetModal" role="dialog">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p>
                      ...
                      software makes it easy to pull together all of your communications and information for your 
                      ...
                      so that you don't end up with data in separate, disconnected silos.
                ...
                <!--  If we want to add more sponsors to our website 
                  <div class="row">
                    ...
                    <center>
                        ...
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#sponsorsModal">More</button>

                    </center>
                  -->
            
              <!-- Sponser modal starts here  -->
                <div class="modal fade" id="sponsorsModal" role="dialog">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Our Sponsors</h4>
                      </div>
                      <div class="modal-body">
                      </div>
                      <div class="modal-footer">
